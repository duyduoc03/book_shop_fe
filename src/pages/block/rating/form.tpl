{strip}
	...
	<div class="overall-rating ">
		<div class="row">
			...
			<div class="col-lg-3 col-12">
		    	...
		    	<div nh-btn-show-rating class="btn btn-submit rounded mt-3 w-100">
	...
	<form nh-form-rating id="rating-form" method="POST" class="rating-form collapse" autocomplete="off">
	    ...
	    <span class="mb-0 btn btn-submit rounded-5" nh-trigger-upload>
			<i class="fa-light fa-camera"></i>
		</span>		

	    <button nh-btn-send-rating class="btn btn-submit rounded-5 ml-3">
